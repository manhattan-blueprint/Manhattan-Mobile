...
public class MockData {
    ...
    private static Resource resourceA = new Resource(8, new Location(51.456, -2.602), 3);
    private static Resource resourceB = new Resource(1, new Location(51.457, -2.603), 3);
    private static Resource resourceC = new Resource(2, new Location(51.458, -2.604), 3);
    private static Resource resourceV = new Resource(3, new Location(51.450, -2.599), 3);
    private static Resource resourceR = new Resource(4, new Location(51.450, -2.600), 3);
    private static Resource resourceX = new Resource(5, new Location(51.449, -2.601), 3);
    private static Resource resourceY = new Resource(6, new Location(51.451, -2.600), 3);
    private static Resource resourceZ = new Resource(7, new Location(51.479, -2.628), 3);
